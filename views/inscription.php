...
<!-- PAGE CONTENT -->
	...
	<article class="page_content inscription_phase" id="inscription_user">
		...
		<form id="user_inscription" action="../modules/insert_user.php" method="post">
			...
			<input type="text" name="local" id="local" placeholder="Localisation au sein de la copropriété"></input>
			<input type="email" name="mail" id="mail" placeholder="mail@exemple.com" required="required"></input>
